namespace wK_Manager.MenuControls
{
    partial class PluginsControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            pluginNameLabel.Size = new Size(400, 21);
            pluginNameLabel.TabIndex = 1;
            pluginNameLabel.Text = "%PluginName%";
            pluginNameLabel.TextAlign = ContentAlignment.MiddleRight;
            // 
            // pluginVersionLabel
            // 
            pluginVersionLabel.Anchor = AnchorStyles.Left | AnchorStyles.Right;
            pluginVersionLabel.AutoSize = true;
            pluginVersionLabel.Location = new Point(509, 3);
            pluginVersionLabel.Name = "pluginVersionLabel";
            pluginVersionLabel.Size = new Size(400, 15);
            ...
            pluginLogoPictureBox.SizeMode = PictureBoxSizeMode.CenterImage;
